...
public class CommonEvents 
{
	...
	public CommonEvents waitTforURLcontainss(String urlpaattern,long seconds){
		new WebDriverWait(driver, Duration.ofSeconds(seconds)).until(ExpectedConditions.urlContains(urlpaattern));
		return new CommonEvents(driver);
	}
	/**
